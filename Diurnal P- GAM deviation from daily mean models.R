...
#The Goal of this script is to find which factors effect deviations from the daily mean TP
...
# Create scatter-plots to find factors that effect deviations from 24 hour mean -------------------------------------------------------
