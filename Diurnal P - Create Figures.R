...
#Pflux data
PFLUX_Events <- read_excel(home_fp, col_types = c("skip", "skip", "skip", "text", "text", "text", "text", "skip",  "skip", "date", "skip", "skip", "skip", "skip", "skip",  "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", "skip", 
"skip", "skip", "skip", "numeric",  "numeric", "numeric", "numeric", "date", "skip", "skip", "skip", "text", "skip", "numeric", "skip",  "skip", "skip", "skip", "skip",  "skip", "skip", "skip", "skip", "skip", "skip", "skip"))
